...
const copy = {
  fr: {
    ...
    builderStudioTitle: "Ateliers IA",
    builderStudioCopy: "Choisis un atelier avance pour preparer les donnees, optimiser un scenario ou orchestrer le copilote.",
    builderStudioKicker: "Modules avances",
    builderStudioResultTitle: "Resultats des ateliers",
  ...
  en: {
    ...
    builderStudioTitle: "AI Workbenches",
    builderStudioCopy: "Choose an advanced workbench to prepare data, optimize a scenario, or orchestrate the copilot.",
    builderStudioKicker: "Advanced modules",
    builderStudioResultTitle: "Workbench results",
